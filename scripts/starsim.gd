...
## The simulation runs on this class.

## Temperature in Kelvins.
@export var temperature:float = 5778

## Masses in Solar masses.
@export var mass:float = 1.234729843247324732894789

## Radius in Solar radius.
@export var radius:float = 1.32498743294723847983274

## Luminosity in Solar radius.
@export var luminosity:float = 1.35645654654645654
...
@export_enum(
	...
	"Wolf-Rayet HB",
	"Wolf-Rayet GB",
	"Helium White Dwarf/Blue Dwarf",
	"White Dwarf",
	"White Dwarf",
	"Neutron Star",
	"Black Hole",
	"No Remnant") var stage: int = 1
